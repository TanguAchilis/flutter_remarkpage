            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: Center(child: Icon(Icons.check, color: Colors.white,size:MediaQuery.of(context).size.width/8 ,),),
                ),

                Text('great', style:TextStyle(color: Colors.white, fontSize: 30, fontWeight: FontWeight.w700),),
                SizedBox(height: MediaQuery.of(context).size.height/80),

                Container(
                  width: MediaQuery.of(context).size.width/2.5,
                  child: Text('now you can enter the data to login', style:TextStyle(color: Colors.white60, fontSize: 20),textAlign:TextAlign.center),
                ),
                ...
                MaterialButton(
                  ...
                  onPressed: (){print('enter pressed function');},
